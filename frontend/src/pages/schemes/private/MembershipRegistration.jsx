        ...
        <div className="space-y-6 animate-fade-in">
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 overflow-y-auto">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl my-4 max-h-[90vh] overflow-y-auto [&_input]:text-gray-900 [&_input]:bg-white [&_select]:text-gray-900 [&_select]:bg-white [&_.form-label]:text-gray-700">
