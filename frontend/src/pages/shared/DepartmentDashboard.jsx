...
const DepartmentDashboard = ({ title, departmentId, type }) => {
    ...
    return (
        <div className="flex flex-col h-full relative">
            ...
            {activeVisit && (
                <div className="fixed inset-0 bg-bg-secondary z-50 flex flex-col p-6 overflow-hidden">
                    <div className="w-full h-full flex flex-col gap-4 relative animate-fade-in">
